...
| [`product/RetailFlow_Analytics_Platform_v0.5.pdf`](RetailFlow_Analytics_Platform_v0.5.pdf) | Product Backlog complet : EPICs, user stories, sprints, architecture et roadmap |
